...
const exportExcel = function(luckysheet, value) {
    ...
    luckysheet.forEach(function(table) {
        ...
        const colHidden=(table.config&&table.config.colhidden)||{}
        const colWidth=(table.config&&table.config.columnlen)||{}
...
var setColumnWidth=function (colWidth,worksheet){
    for (let key in colWidth){
        worksheet.getColumn(parseInt(key)+1).width=colWidth[key]/7.5
    }
